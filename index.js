...
bot.on('message', function (message) {
	var allMessagesCommand = [Ping.parse(message), 
				  Pong.parse(message), 
				  Help.parse(message), 
...
//Commande de modération *delete (bêta)
bot.on('message', async message => {
...
var bvngif = ['6a46f8c384ad3d593bf83da2c0566791','5d7f4de753efeb7001c480d338c3e2a2','dbc6597b27b388e63bb782875fc7140c','007e6615e6f0c06e910505bd596a0fbf',
	      'a53e378bb32fdbcabd28565ae799cfd5','d38cf736909b633bb2e7ff82220196ff','6125378561194636122962e710e40126','a4e89062de0e30a0fb4c6228312d1cb7',
	      'e797bef1e4acb15282db4c785af6e32c','a89290afb528476e1dee4a241b2c4b5b'];
...
const pub = {intro:'Bienvenue à **BAGUETTELAND:tm:** ! N\'hésite pas à jeter un œil à nos réseaux sociaux :\n',
...
bot.on('guildMemberAdd', member => {
  member.createDM().then(channel => {
	...
	//Message d'au-revoir
var dprgif = ['68d182fce1f8b0010c49753a2c9ce9c5','cc2fe047e5a80fa1e0ac7524b8ecaeed','7d0e931bd1ea96df77b33ad5a67b9e4a','8042e3d7ae928e846aa8045d8c8b659f',
	      'b5ff4d9783c61db83962f07155802827','da7396b474b0e0141fd35edd4d0681cf','5ebca9ee619336211a5dd0a0712aa362','18b168cc084d63342ebf2db9614dcfc1',
	      'fc000ba0b39c56c1480f00d9a5793b1c','a7182d0168aa0ad104248cc4abe05737'];
